...
pwtest_rc 0 "create T02 worktree (fresh branch from master)" "$(pwtest_script pw-worktree-create.sh)" "$S2" T95 api master
...
pwtest_rc 2 "fake repo → 2" "$(pwtest_script pw-worktree-create.sh)" "$S2" T01 nope-repo master
