...
```bash
$PW_HOME/tooling/scripts/entities/pw-review-edit.sh init-all <slug>
...
$PW_HOME/tooling/scripts/entities/pw-review-edit.sh signoff <slug> <review-rel-path> <decision> [--by <name>]
...
$PW_HOME/tooling/scripts/entities/pw-review-edit.sh add-item <slug> <review-rel-path> --section <§anchor> (--text <ask…> | --stdin) [--actor <name>]
...
$PW_HOME/tooling/scripts/entities/pw-review-edit.sh answer <slug> <review-rel-path> <Qid> (--text <answer…> | --stdin)
...
$PW_HOME/tooling/scripts/entities/pw-review-edit.sh add-question <slug> <review-rel-path> --section <§anchor> (--text <q…> | --stdin) [--actor <name>]
...
$PW_HOME/tooling/scripts/entities/pw-review-edit.sh resolve <slug> <review-rel-path> <Rid|Qid> (--reply <text…> | --stdin)
