...
guide: [`docs/RFC.md`](../../docs/RFC.md). Backend config: `PW_RFC_BACKEND` in `pw.config.sh` (the
backend registry lives with the machinery — `{{PW_HOME}}/docs/TOOLING.md` says where).
